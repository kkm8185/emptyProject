...
export const metadata: Metadata = {
  title: "CareMedi OpenSource Licenses",
  description: "CareMedi Web View OpenSource Licenses",
}
type Props = {
  ...
  return (
    <div className="relative flex h-full min-h-screen flex-col gap-4">
      <div className="sticky z-10 py-4 text-center">
        <h1 className="text-h5Regular text-caremedi-gray-1000">{messages.openLicenses}</h1>
      </div>
      <LicensesContent searchParams={searchParams} locale={params.locale} />
    </div>
  )
}
