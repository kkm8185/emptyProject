...
export const DropdownMenuGroup = React.forwardRef<
  HTMLDivElement,
  { label?: React.ReactNode } & React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Group>
>(({ label, ...props }, ref) => {
  return (
    <>
...
const dropdownMenuLabelVariants = cva(
  cn("mx-1 select-none px-2 pb-2 pt-1.5 text-xs font-semibold text-muted-foreground"),
  {
    variants: {
      inset: {
        true: "pl-8",
